  ...
  return (
    ...
    <div id="__next" data-reactroot="">
                    ...
                    <div className="css-1uqcsod eurkgsn0">
                        <div className="skinnyBar">
                            <div className="skinnyBar_content">
                                <div aria-hidden="true" className="skinnyBar_text hidden">Up to $40 off SITEWIDE! Don’t miss
                                    out on end-of-year savings!</div>
                                <div className="skinnyBar_text">Up to $40 off SITEWIDE! Don’t miss out on end-of-year
                                    savings!</div>
                            </div>
                            <div className="skinnyBar_cta"><button>Learn more</button></div>
                        </div>
                    </div>
                    <div className="css-13ehr41 e5vbear0">
                        <div className="slideOut_dialog" role="dialog">
                            <div className="slideOut_dialogInner"><button type="button" className="slideOut_dialog_closeBtn"
                                    aria-label="close promo info modal" title="Close dialog"><span color="text.default"
                                        className="css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                            focusable="false" viewBox="0 0 48 48" color="text.default"
                                ...
                                <div className="css-16unm68 e1r8pers0">
                                    ...
                                    <div className="content_body">
                                        <div className="content_bodyMain">
                                            <div className="content_bodyMain_intro"><strong>Last chance of the year to shop
                                                    brilliant hydration on sale! We won’t have an offer this good for a
                                                    while. Shop now while you still can!</strong></div>
                                        ...
                                        <div className="content_bodyActions"><a href="/shop"
                                                className="content_bodyActions_cta css-1xnmvko e10c7x3h0" tabIndex="0"><span
                                                    className="btn_element"><span className="btn_label">Shop
                                                        now</span></span></a></div>
                                        <div className="content_bodyDisclaimer">Offer valid for a limited time only.
                                            Discounts apply to merchandise subtotal before taxes and shipping. Cannot be
                                            combined with other promotions, coupon codes, or retroactively applied to
                                            past purchases. Select products are eligible to stack with the promotional
                                            offer. Hydration Club members will earn points on all purchases; however,
                                            points may not be redeemed toward purchases made during promotional periods.
                                            Other exclusions may apply. Shop the End of the Year offer now through
                                            11:59PM PT, January 6, 2026.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="navigation-head-skinny-wrap">
                            <div className="navigation-head"><button type="button" className="navigation-hamburger"
                                    aria-label="Open main navigation"><svg viewBox="0 0 50 50" fill="none"
                                        ...
                                        aria-label="image with 3 lines representing menu" role="img">
                                        <path
                                ...
                                <div className="navigation-logo"><a aria-label="LARQ Homepage" href="/"><svg width="85"
                                            height="20" viewBox="0 0 85 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" aria-label="Larq logo" role="img">
                                ...
                                <div className="navigation-mobile-account-cart"><a className="navigation-loyalty"
                                        href="/hydration-club-points-and-rewards"><span color="text.default"
                                            ...
                                            className="icon-indicator is-mobile"><span>?</span></span></a><a
                                        className="navigation-account" aria-label="Sign in or register"
                                        href="/user/sign-in"><svg viewBox="0 0 40 40" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" aria-label="User icon" role="img">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                fill="#153A5B"></path>
                                        </svg></a><button className="navigation-cart" aria-label="Open cart slide out"><svg
                                            viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            aria-label="Cart icon" role="img">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <ul>
                                            ...
                                            <li className="icon-item"><a className="navigation-loyalty"
                                                    href="/hydration-club-points-and-rewards"><span color="text.default"
                                                        ...
                                                        className="icon-indicator is-mobile"><span>?</span></span></a></li>
                                            <li className="icon-item account-item"><a className="navigation-account"
                                                    aria-label="Sign in or register" href="/user/sign-in"><svg
                                            ...
                                            <li className="icon-item"><button className="navigation-cart"
                                                    aria-label="Open cart slide out"><svg viewBox="0 0 40 40"
                            ...
                            <div className="cartContainer">
                                <div className="cartContainer_main">
                                    <div className="css-1m2kk2m egzumfh0">
                                        <div className="cartHeaderInfo">Your cart</div><button type="button"
                                            title="Close cart" className="cartHeaderCloseButton"><svg
                                    ...
                                    <div className="css-ium302 e8w5hkd0">
                                        <div className="css-mqwi0x e15jbc1k0">
                                            <div className="cartProgress_inner">
                                                <div className="css-1vzajjh e12j6rpn0">
                                                    ...
                                                    <div className="cartProgressBar_text">You're <strong>$60.00</strong>
                                                        away from getting <strong>$10 off</strong> on your order!</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="cartContentWrap">
                                            <div className="css-1mfavrn epyifc60">
                                                ...
                                                <div className="cartEmptyCta css-b7b9ix e1ty4jc0"><button type="button"
                                                        className="css-1u1hv1v eujwcxh0" data-category="Cart Preview"
                                                        data-action="Check Out Now" data-test="cta-check-out-now">SHOP
                                                        LARQ</button></div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <main id="main-content" className="css-y8aj3r e1jq4geh0">
            <section className="css-1tm6w90 exfz9gz0">
                                ...
                                <div className="mainHero_leftColumn">
                                    <div className="mainHero_details">
                                        <div className="mainHero_details_body">
                                            <h1 className="mainHero_details_body_title">Up to $40 off Sitewide</h1>
                                            <div className="mainHero_details_body_text">Shop and save up to $40 off! Don't
                                                miss the final sale of the year.</div>
                                        </div>
                                        <div className="mainHero_details_footer"><a aria-label="" href="/shop"
                                                className="css-fnfzpo e10c7x3h0" tabIndex="0"><span
                                                    className="btn_element"><span className="btn_label">Shop
                                                        now</span></span></a></div>
                                    </div>
                                </div>
                                <div className="mainHero_rightColumn">
                                    <div className="mainHero_card"></div>
                                </div>
                            </div>
                        </div>
                        <div className="mainHero_cover">
                            <div className="mainImage"><img className="isMobile css-0 e1nv8j4y1"
                                    src="https://res.cloudinary.com/larq/image/fetch/q_auto,f_auto/https://res.cloudinary.com/larq/images/f_auto,q_auto/v1766144751/BoxingDay2025_Hero-Mobile/BoxingDay2025_Hero-Mobile.jpg?_i=AA"
                                    alt="Up to $40 off Sitewide" decoding="async" loading="eager" /><img
                                    className="isDesktop css-0 e1nv8j4y1"
                                    src="https://res.cloudinary.com/larq/image/fetch/q_auto,f_auto/https://res.cloudinary.com/larq/images/f_auto,q_auto/v1766144744/BoxingDay2025_Hero-Desktop/BoxingDay2025_Hero-Desktop.jpg?_i=AA"
                                    alt="Up to $40 off Sitewide" decoding="async" loading="eager" /></div>
                        </div>
                    </div>
                </div>
                <div className="mainHero_additional"></div>
            </section>
                ...
                <div className="css-1ldhsgj">
                    <div className="css-1llzy2o">
                        <div className="css-1ixbp0l e1qsklw40">
                            <div className="anim-reveal" style="opacity:0;transform:translateY(50px) translateZ(0)">
                                    ...
                                    <div className="css-1lcvmkc">
                                        <div className="pageSectionHead_head css-vurnku">
                                            ...
                                            <div className="pageSectionHead_head_addendum">
                                                <div className="exmyjcv0 css-1t50len"><button type="button"
                                                        className="css-16k3ijo e10c7x3h0" disabled="" tabIndex="0"><span
                                                            className="btn_element"><span
                                                                className="btn_label">Featured</span></span></button><button
                                                        aria-label="Show Smart Bottles" type="button"
                                                        className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                            className="btn_element"><span className="btn_label">Smart
                                                                Bottles</span></span></button><button
                                                        aria-label="Show Filtration Bottles" type="button"
                                                        className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                            className="btn_element"><span className="btn_label">Filtration
                                                                Bottles</span></span></button><button
                                                        aria-label="Show Everyday Drinkware" type="button"
                                                        className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                            className="btn_element"><span className="btn_label">Everyday
                                                                Drinkware</span></span></button><button
                                                        aria-label="Show Pitchers" type="button"
                                                        className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                            className="btn_element"><span
                                                                className="btn_label">Pitchers</span></span></button></div>
                                            </div>
                                            <div className="pageSectionHead_head_action"><a aria-label="View all products"
                                                    href="/shop" className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                        className="btn_element"><span className="btn_label">Shop
                                                            all</span></span></a></div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="cardsSwiper_swiper">
                                                <div className="cardsSwiper_swiper_inner">
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle PureVis™ 2 product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-15gsjkl et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    aria-label="View LARQ Bottle PureVis™ 2 Obsidian Black"
                                                                    href="/purification/larq-bottle-purevis-2?sku=BWOB068A">
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle PureVis™ 2 Obsidian Black"
                                                            ...
                                                            <div className="shopCard_content">
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    <div className="css-1wuezs8 eoz2ert0"><a
                                                                            className="productTitle isLink"
                                                                            href="/purification/larq-bottle-purevis-2?sku=BWOB068A">
                                                                            <h3>LARQ Bottle PureVis™ 2</h3>
                                                                        </a></div>
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                                                                            <div
                                                                                ...
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Bottle PureVis™ 2 color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Obsidian Black"
                                                                                            className="css-16unhe5 ek6th1y0"
                                                                                            aria-label="Select Obsidian Black color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                                        className="css-82n8sf e11de7sb0"
                                                                                                        focusable="false"
                                                                                                        viewBox="0 0 32 32"
                                                                                                        color="text.default"
                                                                                                        aria-hidden="true"
                                                                                                    ...
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon cross css-11qxqh7 e1dp28730"><svg
                                                                                                        className="css-82n8sf e11de7sb0"
                                                                                                        focusable="false"
                                                                                                        viewBox="0 0 32 32"
                                                                                                        color="text.default"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-next"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Granite White"
                                                                                            className="css-10sdqrl ek6th1y0"
                                                                                            aria-label="Select Granite White color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Mojave Dune"
                                                                                            className="css-1rv485k ek6th1y0"
                                                                                            aria-label="Select Mojave Dune color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Eucalyptus Green"
                                                                                            className="css-vxiyz9 ek6th1y0"
                                                                                            aria-label="Select Eucalyptus Green color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Luberon Lavender"
                                                                                            className="css-mnvc6h ek6th1y0"
                                                                                            aria-label="Select Luberon Lavender color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Arctic Blue is sold out"
                                                                                            className="css-9ibjn6 ek6th1y0"
                                                                                            aria-label="Select Arctic Blue color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Juniper Green is sold out"
                                                                                            className="css-14bm2j8 ek6th1y0"
                                                                                            aria-label="Select Juniper Green color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Obsidian
                                                                                Black</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle PureVis™ 2 size">
                                                                            <button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                disabled=""
                                                                                aria-label="Select 23 oz size">23
                                                                                oz</button><button type="button"
                                                                                className="css-fajmj4 e1sc3p7b0"
                                                                                aria-label="Select 34 oz size">34
                                                                                oz</button>
                                                                        </div>
                                                                    </div>
                                                                    <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                                                                        <div>Hydration tracking, Self cleaning,
                                                                            Filtration</div>
                                                                    </div>
                                                                    <div className="css-wn1ko exv7rs90">Starting at $114.00
                                                                        instead of $129.00</div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceOld"
                                                                                aria-hidden="true">$129</span> <span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$114</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Pitcher PureVis™ product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-67y418 et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Pitcher PureVis™ Monaco Blue"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                            <div className="shopCard_content">
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    ...
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Pitcher PureVis™ color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Monaco Blue"
                                                                                            className="css-r3dbs5 ek6th1y0"
                                                                                            aria-label="Select Monaco Blue color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-next"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Pure White"
                                                                                            className="css-17l4mkp ek6th1y0"
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Monaco
                                                                                Blue</span></div>
                                                                    </div>
                                                                    <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                                                                        <div>Hydration tracking, Self cleaning,
                                                                    ...
                                                                    <div className="css-wn1ko exv7rs90">Starting at $139.00
                                                                        instead of $168.00</div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceOld"
                                                                                aria-hidden="true">$168</span> <span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$139</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle Swig Top product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-15gsjkl et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle Swig Top Obsidian Black"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    ...
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Bottle Swig Top color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Obsidian Black"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Amber Vittoria Obsidian Black"
                                                                                            className="css-1n6yi8y ek6th1y0"
                                                                                            aria-label="Select Amber Vittoria Obsidian Black color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Amber Vittoria Granite White"
                                                                                            className="css-87hp79 ek6th1y0"
                                                                                            aria-label="Select Amber Vittoria Granite White color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Amalfi Blue is sold out"
                                                                                            className="css-j5fss5 ek6th1y0"
                                                                                            aria-label="Select Amalfi Blue color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Arctic Blue"
                                                                                            className="css-zoei5r ek6th1y0"
                                                                                            aria-label="Select Arctic Blue color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Obsidian
                                                                                Black</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle Swig Top size">
                                                                            <button type="button"
                                                                                className="css-fajmj4 e1sc3p7b0"
                                                                                aria-label="Select 23 oz size">23
                                                                                oz</button><button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                aria-label="Select 34 oz size"
                                                                                disabled="">34 oz</button>
                                                                        </div>
                                                                    </div>
                                                                    <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                                                                        <div>Everyday drinkware</div>
                                                                    </div>
                                                                    <div className="css-wn1ko exv7rs90">Starting at $49.95
                                                                    </div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$49.95</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle Filtered Swig Top product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-ktbb9c et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle Filtered Swig Top Eucalyptus Green"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                            <div className="shopCard_content">
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    <div className="css-1wuezs8 eoz2ert0"><a
                                                                            className="productTitle isLink"
                                                                            href="/purification/larq-bottle-filtered-swig-top?sku=BFBNWEG068ABFAW068A">
                                                                            <h3>LARQ Bottle Filtered Swig Top</h3>
                                                                        </a></div>
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                                                                            <div
                                                                                ...
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Eucalyptus Green is sold out"
                                                                                            className="css-10037kw ek6th1y0"
                                                                                            aria-label="Select Eucalyptus Green color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-next"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Obsidian Black is sold out"
                                                                                            className="css-1xfs2ko ek6th1y0"
                                                                                            aria-label="Select Obsidian Black color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Granite White is sold out"
                                                                                            className="css-10sdqrl ek6th1y0"
                                                                                            aria-label="Select Granite White color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Amber Vittoria Obsidian Black is sold out"
                                                                                            className="css-1n6yi8y ek6th1y0"
                                                                                            aria-label="Select Amber Vittoria Obsidian Black color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Amber Vittoria Granite White is sold out"
                                                                                            className="css-87hp79 ek6th1y0"
                                                                                            aria-label="Select Amber Vittoria Granite White color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Luberon Lavender is sold out"
                                                                                            className="css-mnvc6h ek6th1y0"
                                                                                            aria-label="Select Luberon Lavender color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20">
                                                                            <span>Eucalyptus Green</span>
                                                                        </div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle Filtered Swig Top size">
                                                                            <button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                disabled=""
                                                                                aria-label="Select 23 oz size">23
                                                                    ...
                                                                    <div className="css-wn1ko exv7rs90">Starting at $49.95
                                                                        instead of $55.00</div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceOld"
                                                                                aria-hidden="true">$55</span> <span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$49.95</span></div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle PureVis™ product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-1cj8om4 et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle PureVis™ Monaco Blue"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    ...
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Bottle PureVis™ color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Monaco Blue"
                                                                                            className="css-dk8zb3 ek6th1y0"
                                                                                            aria-label="Select Monaco Blue color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item"
                                                                                        style="margin-right: 8px;">
                                                                                        <button
                                                                                            title="Seaside Mint is sold out"
                                                                                            className="css-1t18tmr ek6th1y0"
                                                                                            aria-label="Select Seaside Mint color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Monaco
                                                                                Blue</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle PureVis™ size">
                                                                            <button type="button"
                                                                                className="css-fajmj4 e1sc3p7b0"
                                                                                aria-label="Select 17 oz size">17
                                                                                oz</button><button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                aria-label="Select 25 oz size"
                                                                                disabled="">25 oz</button>
                                                                        </div>
                                                                    </div>
                                                                    <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                                                                        <div>Self cleaning</div>
                                                                    </div>
                                                                    <div className="css-wn1ko exv7rs90">Starting at $109.00
                                                                    </div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$109</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle Filtered Flip Top product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-1ryxl2a et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle Filtered Flip Top Granite White"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                            <div className="shopCard_content">
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    <div className="css-1wuezs8 eoz2ert0"><a
                                                                            className="productTitle isLink"
                                                                            href="/purification/larq-bottle-filtered-flip-top?sku=BFDGW050A">
                                                                            <h3>LARQ Bottle Filtered Flip Top</h3>
                                                                        </a></div>
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Granite
                                                                                White</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle Filtered Flip Top size">
                                                                            <button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                disabled=""
                                                                                aria-label="Select 17 oz size">17
                                                                                oz</button><button type="button"
                                                                                className="css-fajmj4 e1sc3p7b0"
                                                                                aria-label="Select 25 oz size">25
                                                                                oz</button>
                                                                        </div>
                                                                    </div>
                                                                    <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                                                                    ...
                                                                    <div className="css-wn1ko exv7rs90">Starting at $49.50
                                                                        instead of $55.00</div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceOld"
                                                                                aria-hidden="true">$55</span> <span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$49.50</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle Flip Top product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-15gsjkl et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle Flip Top Obsidian Black"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    ...
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Bottle Flip Top color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Obsidian Black"
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Obsidian
                                                                                Black</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle Flip Top size">
                                                                            <button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                disabled=""
                                                                                aria-label="Select 17 oz size">17
                                                                    ...
                                                                    <div className="css-wn1ko exv7rs90">Starting at $39.95
                                                                    </div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$39.95</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div aria-label="LARQ Bottle Twist Top product"
                                                            className="css-k9fih1 eoes6mn0">
                                                            <div className="css-11j2dj0 e1aghnsr0">
                                                                <div className="css-1cj8om4 et5ovjm0"></div><a
                                                                    className="productMedia_wrap isLink"
                                                                    ...
                                                                    <div className="productMedia">
                                                                        <div className="productMedia_asset"><img
                                                                                ...
                                                                                alt="LARQ Bottle Twist Top Monaco Blue"
                                                                                decoding="async" loading="lazy" /></div>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="shopCard_content_body">
                                                                    ...
                                                                    <div className="shopCard_colorsPicker">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                                                                                <div className="colorsPickerSwiper_wrapper"
                                                                                    aria-label="Select LARQ Bottle Twist Top color"
                                                                                    style="transform: translate3d(0px, 0px, 0px);">
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-active"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Monaco Blue"
                                                                                    ...
                                                                                    <div className="colorsPickerSwiper_item swiper-slide-next"
                                                                                        style="margin-right: 8px;">
                                                                                        <button title="Himalayan Pink"
                                                                                            className="css-1rbo0kz ek6th1y0"
                                                                                            aria-label="Select Himalayan Pink color"
                                                                                            type="button"><span
                                                                                                className="swatch"><span
                                                                                                    color="text.default"
                                                                                                    className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                                                    ...
                                                                    <div className="shopCard_variantsInfo">
                                                                        <div className="css-1mb10vo eglraj20"><span>Monaco
                                                                                Blue</span></div>
                                                                        <div className="css-8w8d45 e7c9lfa0"
                                                                            aria-label="Select LARQ Bottle Twist Top size">
                                                                            <button type="button"
                                                                                className="css-1bnu34p e1sc3p7b0"
                                                                                disabled=""
                                                                                aria-label="Select 17 oz size">17
                                                                    ...
                                                                    <div className="css-wn1ko exv7rs90">Starting at $29.95
                                                                    </div>
                                                                    <div className="css-cdckcp exbswh30" aria-hidden="true">
                                                                        <div className="priceContainer"><span
                                                                                className="priceCurrent"
                                                                                aria-hidden="true">$29.95</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="cardsSwiper_swiper_item">
                                                        <div className="css-gsm2yv e9bt58b0"><a className="mediaTextCard isLink"
                                                                aria-label="View LARQ Products" href="/shop">
                                                                <div className="mediaTextCard_media"><img
                                                                        className="mediaTextCard_media_asset css-0 e1nv8j4y1"
                                                                        src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1738327334/assets/spa/v3/shop/content/collections/bottles.jpg"
                                                                        alt="Athlete holding LARQ Bottle PureVis 2 Obsidian Black in hand"
                                                                        decoding="async" loading="lazy" /></div>
                                                                <div className="mediaTextCard_body">
                                                                    <div className="mediaTextCard_content">
                                                                        <div className="mediaTextCard_content_body">
                                                                            <div
                                                                                className="mediaTextCard_content_body_main">
                                                                                <h3
                                                                                    className="mediaTextCard_content_body_main_title">
                                                                                    LARQ Products</h3>
                                                                                <div
                                                                                    className="mediaTextCard_content_body_main_text">
                                                                                    Browse LARQ products that fit your
                                                                                    needs.</div>
                                                                            </div>
                                                                            <div
                                                                                className="mediaTextCard_content_body_action">
                                                                                <button type="button"
                                                                                    className="mediaTextCard_content_body_actionCta css-uumepb e10c7x3h0"
                                                                                    tabIndex="-1"
                                                                                    aria-hidden="true"><span
                                                                                        className="btn_element"><span
                                                                                            className="btn_label">Shop
                                                                                            now</span></span></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </a></div><span className="u-inView"></span>
                                                    </div>
                                                </div>
                                                <div className="cardsSwiper_navigation"><button tabIndex="-1"
                                                        title="Previous product" type="button"
                                                        className="cardsSwiper_navigation_arrow isPrevious"><span
                                                            color="text.default" className="css-11qxqh7 e1dp28730"><svg
                                                                className="css-82n8sf e11de7sb0" focusable="false"
                                                                viewBox="0 0 16 10" color="text.default"
                                                                aria-hidden="true" fill="undefined">
                                                                <path
                                                                    d="m4.625 9.86-4.5-4.5C.031 5.265 0 5.14 0 4.983a.47.47 0 0 1 .125-.343l4.5-4.5a.53.53 0 0 1 .719 0 .53.53 0 0 1 0 .718L1.687 4.484H15.5c.25 0 .5.25.5.5 0 .282-.25.5-.5.5H1.687l3.657 3.657a.53.53 0 0 1 0 .718.53.53 0 0 1-.719 0Z">
                                                                </path>
                                                            </svg></span></button><button title="Next product"
                                                        type="button" className="cardsSwiper_navigation_arrow isNext"><span
                                                            color="text.default" className="css-11qxqh7 e1dp28730"><svg
                                                                className="css-82n8sf e11de7sb0" focusable="false"
                                                                viewBox="0 0 16 10" color="text.default"
                                                                aria-hidden="true" fill="undefined">
                                                                <path
                                                                    d="m11.375.14 4.5 4.5c.094.094.125.22.125.376a.47.47 0 0 1-.125.343l-4.5 4.5a.53.53 0 0 1-.719 0 .53.53 0 0 1 0-.718l3.656-3.625H.5c-.25 0-.5-.25-.5-.5 0-.282.25-.5.5-.5h13.813L10.655.859a.53.53 0 0 1 0-.718.53.53 0 0 1 .719 0Z">
                                                                </path>
                                                            </svg></span></button></div>
                                            </div>
                                            <div className="cardsSwiper_barNavigation">
                                                <div className="cardsSwiper_barNavigation_bar"><button
                                                        aria-label="View product 1" type="button"
                                                        className="isActiveBar"></button><button aria-label="View product 2"
                                                        type="button" className=""></button><button
                                                        aria-label="View product 3" type="button"
                                                        className=""></button><button aria-label="View product 4"
                                                        type="button" className=""></button><button
                                                        aria-label="View product 5" type="button"
                                                        className=""></button><button aria-label="View product 6"
                                                        type="button" className=""></button><button
                                                        aria-label="View product 7" type="button"
                                                        className=""></button><button aria-label="View product 8"
                                                        type="button" className=""></button><button
                                                        aria-label="View product 9" type="button" className=""></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="css-1sb5546 e30gkoa0">
                                        ...
                                        <div className="marquee css-13e9yuk e1queap70"
                                            ...
                                            <div className="rfm-marquee"
                                                ...
                                                <div className="rfm-initial-child-container">
                                                    ...
                                                    <div className="rfm-child" style="--transform: none;">
                                                        <div className="css-ufgyje epv5ier0">
                                                            <div className="marqueeItem_text">Friends don’t let friends
                                                                dehydrate.</div>
                                                        </div>
                                                    </div>
                                                    <div className="rfm-child" style="--transform: none;">
                                                    ...
                                                    <div className="rfm-child" style="--transform: none;">
                                                        <div className="css-ufgyje epv5ier0">
                                                            <div className="marqueeItem_text">How many sips does it take to
                                                                be amazing?</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="rfm-marquee"
                                                ...
                                                <div className="rfm-child" style="--transform: none;">
                                                    <div className="css-ufgyje epv5ier0">
                                                        <div className="marqueeItem_text">How many sips does it take to be
                                                            amazing?</div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="css-1ixbp0l e1qsklw40">
                            <div className="anim-reveal" style="opacity:0;transform:translateY(50px) translateZ(0)">
                                <div className="css-krdsss ed1k4l40">
                                    <div className="css-1lcvmkc">
                                        <div className="pageSectionHead_head css-vurnku">
                                            <h2 className="pageSectionHead_head_title">Shop LARQ</h2>
                                            <div className="pageSectionHead_head_action"><a aria-label="View all products"
                                                    href="/shop" className="css-139p19l e10c7x3h0" tabIndex="0"><span
                                                        className="btn_element"><span className="btn_label">Shop
                                                            all</span></span></a></div>
                                ...
                                <div className="css-2y67pd ek1zip20">
                                    <div className="cardsSwiper_inner">
                                        <div className="cardsSwiper_swiper">
                                            <div className="cardsSwiper_swiper_inner">
                                                <div className="cardsSwiper_swiper_item">
                                                    <div className="css-1ywse7n e9bt58b0"><a className="mediaTextCard isLink"
                                                            aria-label="View Bottles" href="/shop/bottles">
                                                            <div className="mediaTextCard_media"><img
                                                                    className="mediaTextCard_media_asset css-0 e1nv8j4y1"
                                                                    src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1738327334/assets/spa/v3/shop/content/collections/bottles.jpg"
                                                                    alt="Athlete holding LARQ Bottle PureVis 2 Obsidian Black in hand"
                                                                ...
                                                                <div className="mediaTextCard_content">
                                                                    <div className="mediaTextCard_content_body">
                                                                        <div className="mediaTextCard_content_body_main">
                                                                            ...
                                                                            <div
                                                                                className="mediaTextCard_content_body_main_text">
                                                                                Browse water bottles that fit your
                                                                                needs.</div>
                                                                        </div>
                                                                        <div className="mediaTextCard_content_body_action">
                                                                            <button type="button"
                                                                                className="mediaTextCard_content_body_actionCta css-uumepb e10c7x3h0"
                                                ...
                                                <div className="cardsSwiper_swiper_item">
                                                    <div className="css-1ywse7n e9bt58b0"><a className="mediaTextCard isLink"
                                                            aria-label="View Pitchers" href="/shop/pitchers">
                                                            <div className="mediaTextCard_media"><img
                                                                    className="mediaTextCard_media_asset css-0 e1nv8j4y1"
                                                                    src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1738327334/assets/spa/v3/shop/content/collections/pitchers.jpg"
                                                                    alt="Woman holding LARQ Pitcher Pure White"
                                                                    decoding="async" loading="lazy" /></div>
                                                            <div className="mediaTextCard_body">
                                                                <div className="mediaTextCard_content">
                                                                    <div className="mediaTextCard_content_body">
                                                                        <div className="mediaTextCard_content_body_main">
                                                                            ...
                                                                            <div
                                                                                className="mediaTextCard_content_body_main_text">
                                                                                Equip your home with Nano Zero
                                                                                filtration.</div>
                                                                        </div>
                                                                        <div className="mediaTextCard_content_body_action">
                                                                            <button type="button"
                                                ...
                                                <div className="cardsSwiper_swiper_item">
                                                    <div className="css-1ywse7n e9bt58b0"><a className="mediaTextCard isLink"
                                                            aria-label="View accessories" href="/shop/accessories">
                                                            <div className="mediaTextCard_media"><img
                                                                    className="mediaTextCard_media_asset css-0 e1nv8j4y1"
                                                                    src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1738327334/assets/spa/v3/shop/content/collections/accessories.jpg"
                                                                    alt="Tennis player drinking water from a LARQ Bottle"
                                                                    decoding="async" loading="lazy" /></div>
                                                            <div className="mediaTextCard_body">
                                                                <div className="mediaTextCard_content">
                                                                    <div className="mediaTextCard_content_body">
                                                                        <div className="mediaTextCard_content_body_main">
                                                                            ...
                                                                            <div
                                                                                className="mediaTextCard_content_body_main_text">
                                                                                Customize your on-the-go hydration with
                                                                                accessories.</div>
                                                                        </div>
                                                                        <div className="mediaTextCard_content_body_action">
                                                                            <button type="button"
                                            ...
                                            <div className="cardsSwiper_navigation"><button tabIndex="-1"
                                                    ...
                                                    className="cardsSwiper_navigation_arrow isPrevious"><span
                                                        color="text.default" className="css-11qxqh7 e1dp28730"><svg
                                                            className="css-82n8sf e11de7sb0" focusable="false"
                                                            viewBox="0 0 16 10" color="text.default" aria-hidden="true"
                                                            fill="undefined">
                                                            <path
                                                                d="m4.625 9.86-4.5-4.5C.031 5.265 0 5.14 0 4.983a.47.47 0 0 1 .125-.343l4.5-4.5a.53.53 0 0 1 .719 0 .53.53 0 0 1 0 .718L1.687 4.484H15.5c.25 0 .5.25.5.5 0 .282-.25.5-.5.5H1.687l3.657 3.657a.53.53 0 0 1 0 .718.53.53 0 0 1-.719 0Z">
                                                            </path>
                                                        </svg></span></button><button title="Next product" type="button"
                                                    className="cardsSwiper_navigation_arrow isNext"><span
                                                        color="text.default" className="css-11qxqh7 e1dp28730"><svg
                                                            className="css-82n8sf e11de7sb0" focusable="false"
                                                            viewBox="0 0 16 10" color="text.default" aria-hidden="true"
                                                            fill="undefined">
                                        ...
                                        <div className="cardsSwiper_barNavigation">
                                            <div className="cardsSwiper_barNavigation_bar"><button
                                                    aria-label="View product 1" type="button"
                                                    className="isActiveBar"></button><button aria-label="View product 2"
                                                    type="button" className=""></button><button aria-label="View product 3"
                                                    type="button" className=""></button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="css-fusls1 ed1k4l40">
                                    <div className="css-1lcvmkc">
                                        ...
                                        <div className="pageSectionHead_body css-vurnku">
                                            <div className="css-1wl92z8 ef3daqn0" aria-label="Rated 4.7 out of 5 stars">
                                                <ul className="rating-stars">
                                                    <li><svg viewBox="0 0 22 21" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg" aria-label="Star icon"
                                                            role="img">
                                                            <path
                                                                d="M11 0.5L13.4609 8.15625H21.5078L14.9844 12.8828L17.4844 20.5L11 15.8125L4.47656 20.5L6.97656 12.8828L0.453125 8.15625H8.5L11 0.5Z"
                                                                fill="#F3756D"></path>
                                                        </svg></li>
                                                    <li><svg viewBox="0 0 22 21" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg" aria-label="Star icon"
                                                ...
                                                </ul><a className="rating-total"
                                                    href="/purification/larq-bottle-purevis/reviews">based on 14381
                                                    reviews</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="css-raub1f epel50u0">
                                        <div className="css-1it8wzf epel50u1">
                                            <div className="css-t7h8wa evwaukm0">
                                                <div className="wrap">
                                                    <div className="productMediaCard">
                                                        <div className="productMediaCard_media"><button className="play-button"
                                                                aria-label="Play video"><span color="text.default"
                                                                    className="css-11qxqh7 e13u1hot0"><svg
                                                                        className="css-82n8sf e11de7sb0" focusable="false"
                                                                        viewBox="0 0 120 120" color="text.default"
                                                                        aria-hidden="true" fill="undefined">
                                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                                            d="M48.8204 82.2042C48.0075 81.7691 47.5 80.922 47.5 80L47.5 40C47.5 39.078 48.0075 38.2309 48.8204 37.7958C49.6333 37.3608 50.6196 37.4084 51.3868 37.9199L81.3868 57.9199C82.0823 58.3835 82.5 59.1641 82.5 60C82.5 60.8359 82.0823 61.6165 81.3868 62.0801L51.3868 82.0801C50.6196 82.5916 49.6333 82.6392 48.8204 82.2042ZM52.5 75.3287L75.4931 60L52.5 44.6713L52.5 75.3287Z"
                                                                            fill="white"></path>
                                                                    </svg></span></button><video tabIndex="-1"
                                                                className="productMediaCard_media_asset" playsinline=""
                                                                loop=""
                                                                src="https://res.cloudinary.com/larq/video/upload/v1743173385/selected-reviews-videos/bottle-filtered-flip-top/optimized/640/bottle-filtered-flip-top-07.mp4"></video>
                                                        </div>
                                                    </div>
                                                    <div className="product-info-wrap"><a className="overlay-link"
                                                            href="/purification/larq-bottle-filtered-flip-top?sku=BFDGW074A">Link
                                                            to LARQ Bottle Filtered Flip Top - Granite White product</a>
                                                        <div className="product-info-container">
                                                            <div className="product-info">
                                                                <div className="product-info-image css-103pskz e1nv8j4y0">
                                                                    <img className="css-0 e1nv8j4y1"
                                                                        src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/w_400/v1738137667/SKU/SPA/v3/BFDGW074A.png"
                                                                        alt="LARQ Bottle Filtered Flip Top - Granite White image"
                                                                        decoding="async" loading="lazy" />
                                                                </div>
                                                                <div className="product-info-body">
                                                                    <h4 className="title">LARQ Bottle Filtered Flip Top</h4>
                                                                    <p className="subtitle">Granite White</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="css-pm7ku3 eqi9v9q0">
                                                <div className="feedbackCard_content">The app to be honest, the most
                                                    important thing to me; and everyone for that matter is our water
                                                    intake, because a lot of people don’t know how much water they
                                                    should be drinking within a day. The LARQ app makes it so that’s no
                                                    longer a problem since it tells you how much you should be drinking,
                                                    tailored to you.</div>
                                                <div className="feedbackCard_source">
                                                    <div className="user-info">
                                                        <div className="name-handle"><strong className="name">Andre
                                                                Rogers</strong><small className="handle">Canada, Verified
                                                                Buyer</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="css-1it8wzf epel50u1">
                                            <div className="css-pm7ku3 eqi9v9q0">
                                                <div className="feedbackCard_content">Love the look of the bottle, the
                                                    filtration system and the taste of the water is so pure. The
                                                    self-cleaning feature is the cherry on top!</div>
                                                <div className="feedbackCard_source">
                                                    <div className="user-info">
                                                        <div className="name-handle"><strong className="name">Jessica Marchese
                                                                Barbosa</strong><small className="handle">Canada, Verified
                                                                Buyer</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="css-pm7ku3 eqi9v9q0">
                                                <div className="feedbackCard_content">So far, this has been one of the best
                                                    acquisitions for our well-being and physical health. It not only
                                                    helps us keep track of our hydration goals but also effectively
                                                    filters and sanitizes our water. Plus, the battery life is truly
                                                    unmatched.</div>
                                                <div className="feedbackCard_source">
                                                    <div className="user-info">
                                                        <div className="name-handle"><strong className="name">Rubiel Andres
                                                                Merino Restrepo</strong><small className="handle">Canada,
                                                                Verified Buyer</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="css-11ttxr7 eqi9v9q0">
                                                <div className="feedbackCard_content">The result is that every glass of
                                                    water tastes crisp and fresh.</div>
                                                <div className="feedbackCard_logo"><img className="css-0 e1nv8j4y1"
                                                        src="https://res.cloudinary.com/larq/image/upload/v1743228143/selected-reviews-logo/the-oprah-magazine.png"
                                                        alt="The Oprah Magazine logo" decoding="async" loading="lazy" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="css-1it8wzf epel50u1">
                                            <div className="css-11ttxr7 eqi9v9q0">
                                                <div className="feedbackCard_content">What’s the Next Status Water Bottle?
                                                    Three of our experts named the LARQ bottle as one to watch.</div>
                                                <div className="feedbackCard_logo"><img className="css-0 e1nv8j4y1"
                                                        src="https://res.cloudinary.com/larq/image/upload/v1743228143/selected-reviews-logo/the-strategist.png"
                                                        alt="The Strategist logo" decoding="async" loading="lazy" /></div>
                                            </div>
                                            <div className="css-t7h8wa evwaukm0">
                                                <div className="wrap">
                                                    <div className="productMediaCard">
                                                        <div className="productMediaCard_media"><button className="play-button"
                                                                ...
                                                                className="productMediaCard_media_asset" playsinline=""
                                                                loop=""
                                                                src="https://res.cloudinary.com/larq/video/upload/v1744961145/selected-reviews-videos/pitcher-pure-vis/optimized/640/pitcher-02_opt.mp4"></video>
                                                        </div>
                                                    </div>
                                                    <div className="product-info-wrap"><a className="overlay-link"
                                                            href="/home/larq-pitcher-purevis?sku=PAPW190A">Link to LARQ
                                                            Pitcher PureVis™ - Pure White product</a>
                                                        <div className="product-info-container">
                                                            <div className="product-info">
                                                                <div className="product-info-image css-103pskz e1nv8j4y0">
                                                                    <img className="css-0 e1nv8j4y1"
                                                                        src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/w_400/v1738137667/SKU/SPA/v3/PAPW190A.png"
                                                                        alt="LARQ Pitcher PureVis™ - Pure White image"
                                                                        decoding="async" loading="lazy" />
                                                                </div>
                                                                <div className="product-info-body">
                                                                    <h4 className="title">LARQ Pitcher PureVis™</h4>
                                                                    <p className="subtitle">Pure White</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="css-1it8wzf epel50u1">
                                                ...
                                                <div className="wrap">
                                                    <div className="productMediaCard">
                                                        <div className="productMediaCard_media"><button className="play-button"
                                                                ...
                                                                className="productMediaCard_media_asset" playsinline=""
                                                                loop=""
                                                                src="https://res.cloudinary.com/larq/video/upload/v1744961145/selected-reviews-videos/pitcher-pure-vis/optimized/640/pitcher-01_opt.mp4"></video>
                                                        </div>
                                                    </div>
                                                    <div className="product-info-wrap"><a className="overlay-link"
                                                            href="/home/larq-pitcher-purevis?sku=PAMB190A">Link to LARQ
                                                            Pitcher PureVis™ - Monaco Blue product</a>
                                                        <div className="product-info-container">
                                                            <div className="product-info">
                                                                <div className="product-info-image css-103pskz e1nv8j4y0">
                                                                    <img className="css-0 e1nv8j4y1"
                                                                        src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/w_400/v1738137667/SKU/SPA/v3/PAMB190A.png"
                                                                        alt="LARQ Pitcher PureVis™ - Monaco Blue image"
                                                                        decoding="async" loading="lazy" />
                                                                </div>
                                                                <div className="product-info-body">
                                                                    <h4 className="title">LARQ Pitcher PureVis™</h4>
                                                                    <p className="subtitle">Monaco Blue</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="css-11ttxr7 eqi9v9q0">
                                                <div className="feedbackCard_content">You Should Ditch Your Old Water
                                                    Dispenser For The High-Tech LARQ Pitcher PureVis™.</div>
                                                <div className="feedbackCard_logo"><img className="css-0 e1nv8j4y1"
                                                        src="https://res.cloudinary.com/larq/image/upload/v1743228143/selected-reviews-logo/best-products.png"
                                                        alt="Best Products logo" decoding="async" loading="lazy" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="css-nejygk e1cm9nc20">
                <div className="css-6aa05y">
                    <div className="css-1llzy2o">
                        <div className="css-1ixbp0l e1qsklw40">
                            <div className="anim-reveal" style="opacity:0;transform:translateY(50px) translateZ(0)">
                                <section className="css-mmakay eu0hz6r0">
                                    <div className="content-wrap">
                                        <div className="media"><video tabIndex="-1"
                                                src="https://res.cloudinary.com/larq/video/upload/v1751905034/assets/spa/v3/content/video/WQ-Loop-Short-v2_1280_opt.mp4"
                                                playsinline="" muted="" loop="" autoplay=""
                                                title="Water quality presentation video" className="media-asset"></video>
                                        </div>
                                        <div className="content-inner">
                                            <div className="content">
                                                <h3 className="title">What's in your tap water?</h3>
                                                <div className="lead">Legal limits are designed to keep us safe, but
                                                    contaminants still slip through the cracks. Find out what's lurking
                                                    in your water.</div>
                                                <form>
                                                    <div className="field">
                                                        <div className="text-field css-vd0u8f e9xz9un0">
                                                            <div className="inputContainer">
                                                                <div className="inputContainer_inner">
                                                                    <div className="inputWrap"><input type="text"
                                                                            name="zipCode" aria-invalid="false"
                                                                            id="zipCode" value=""
                                                                            placeholder="Enter ZIP" /></div>
                                                                </div>
                                                            </div>
                                                        </div><button type="submit" className="action-button"
                                                            aria-label="Analyze water in your area">Analyze</button>
                                                    </div>
                                                </form>
                                                <div className="fineprint">Our database pulls data from multiple data
                                                    sources such as EWG and EPA to give users the most comprehensive
                                                    view of their water quality.</div>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                    ...
                    <div className="slideOut_dialogInner"><button type="button" className="slideOut_dialog_closeBtn"
                            aria-label="close plan info modal" title="Close dialog"><span color="text.default"
                                className="css-11qxqh7 e13u1hot0"><svg className="css-82n8sf e1x3lr430" focusable="false"
                                    viewBox="0 0 42 26" color="text.default" aria-hidden="true">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M28.707.293l12 12L40 13l.707.707-12 12-1.414-1.414L37.586 14H0v-2h37.586L27.293 1.707 28.707.293z"
                                        fill="#153A5B"></path>
                                </svg></span></button>
                        <div className="css-193jg0i e19kizl40">
                            <div className="content">
                                <div className="contentInner">
                                    <div className="content_head">
                                        <h3 className="content_headTitle"><strong>What Contaminants Are Lurking in Your Tap
                                                Water?</strong><br />And how the right filter can help you breathe easy.
                                        </h3>
                                    </div>
                                    <div className="content_body">
                                        <div className="content_bodyContent">
                                            <ol>
                                                <li><strong>Chlorine</strong>
                                                    <ul>
                                                        <li>Used to disinfect water</li>
                                                        <li>Can cause bad taste, odor, and skin irritation</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Lead</strong>
                                                    <ul>
                                                        <li>Leaches from old pipes &amp; plumbing</li>
                                                        <li>Linked to developmental issues, especially in children</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Mercury</strong>
                                                    <ul>
                                                        <li>Byproduct of industrial waste</li>
                                                        <li>Can damage kidneys &amp; nervous system</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Asbestos</strong>
                                                    <ul>
                                                        <li>From aging water mains</li>
                                                        <li>Potential cancer risk when inhaled or ingested</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Chloramine</strong>
                                                    <ul>
                                                        <li>Alternative to chlorine for disinfection</li>
                                                        <li>Can cause skin and respiratory issues</li>
                                                    </ul>
                                                </li>
                                                <li><strong>VOCS (Volatile Organic Compounds)</strong>
                                                    <ul>
                                                        <li>From pesticides, solvents, &amp; industrial runoff</li>
                                                        <li>Can affect liver, kidneys &amp; immune system</li>
                                                    </ul>
                                                </li>
                                                <li><strong>PFAS ("Forever Chemicals")</strong>
                                                    <ul>
                                                        <li>Found in non-stick cookware, plastic bottles, &amp; food
                                                            wrappers. Persistent in drinking water supplies</li>
                                                        <li>Linked to immune &amp; hormone issues</li>
                                                    </ul>
                                                </li>
                                            </ol>
                                            <p><strong>Look for filters labeled NSF/ANSI 42 (aesthetic effects) and
                                                    NSF/ANSI 53 (health-related contaminants) to ensure effective
                                                    protection.</strong></p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="content-wrap">
                <div className="signup-navigation">
                    <div className="newsletter-social">
                        <div className="css-1fpzjnr e8cz3w80"><a className="newsletter-logo" aria-label="LARQ Homepage"
                                href="/"><svg width="85" height="20" viewBox="0 0 85 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" aria-label="Larq logo" role="img">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M74.7998 16.9523C71.0144 16.9523 67.8164 13.6743 67.8164 9.79426C67.8164 5.91404 71.0144 2.63602 74.7998 2.63602C78.5852 2.63602 81.7831 5.91404 81.7831 9.79426C81.7831 11.2661 81.3218 12.6507 80.5439 13.8033L78.4165 11.642L76.6477 13.4391L78.7948 15.6206C77.654 16.4549 76.272 16.9523 74.7998 16.9523ZM84.7023 18.0283L82.5766 15.8685C83.9015 14.2143 84.6865 12.1116 84.6865 9.79426C84.6865 4.33536 80.3436 0.0597534 74.7998 0.0597534C69.2556 0.0597534 64.9127 4.33536 64.9127 9.79426C64.9127 15.2529 69.2556 19.5288 74.7998 19.5288C77.0548 19.5288 79.1111 18.8211 80.7572 17.6143L82.9335 19.8255L84.7023 18.0283Z"
                                        fill="#153A5B"></path>
                            ...
                            <p className="newsletter-subtitle">Receive exclusive offers, hydration news, and more when you
                                subscribe.</p>
                            <form className="newsletter-form">
                                <div className="newsletterBlock_input css-11ubf4d e9xz9un0"><label
                                        htmlFor="footerNewsletter_subscribe" id="footerNewsletter_subscribe-inputLabel"
                                        className="label css-pk0vug ecs51n50"><span>Enter your
                                            email</span><small>Required</small></label>
                                    <div className="inputContainer">
                                        <div className="inputContainer_inner">
                                            <div className="inputWrap"><input type="email" name="email" aria-invalid="false"
                                                    id="footerNewsletter_subscribe" value=""
                    ...
                    <nav role="navigation" className="footer-navigation css-1vahihd e1kzia1a0">
                        <nav className="footer-mobile-navigation">
                            <ul className="footer-mobile">
                                ...
                                <li><a href="https://basq.livelarq.com" rel="noopener noreferrer" target="_blank">basq
                                        magazine</a></li>
                                <li><a href="/retailers">Find a retailer</a></li>
                                <li><a href="/exclusive-perks">Exclusive Perks</a></li>
                                <li><a href="https://faire.com/direct/larq" rel="noopener noreferrer"
                                        target="_blank">Wholesale</a></li>
                                <li><a href="https://larq.aspireiq.com/join/ambassador-program"
                                        rel="noopener noreferrer" target="_blank">Ambassador program</a></li>
                    ...
                    <div className="css-1wl4mu6 e9bt58b0"><a className="mediaTextCard isLink"
                            ...
                            <div className="mediaTextCard_media"><img className="mediaTextCard_media_asset css-0 e1nv8j4y1"
                                    ...
                                    alt="Man holding LARQ bottle with Spotify branding" decoding="async" loading="lazy" />
                            </div>
                            <div className="mediaTextCard_body">
                                <div className="mediaTextCard_content">
                                    <div className="mediaTextCard_content_body">
                                        <div className="mediaTextCard_content_body_main">
                                            ...
                                            <div className="mediaTextCard_content_body_main_text">Originality never goes out
                                                of style</div>
                                        </div>
                                        <div className="mediaTextCard_content_body_action"><button type="button"
                                                className="mediaTextCard_content_body_actionCta css-uumepb e10c7x3h0"
                                                tabIndex="-1" aria-hidden="true"><span className="btn_element"><span
                                                        className="btn_label">Get a quote</span></span></button></div>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                ...
                <div className="location-legal-payment">
                            ...
                            <li>
                                <div className="iub__us-widget">
                                    <ul className="iub__us-widget__wrapper">
                                        <li><button className="iubenda-cs-preferences-link button-link" type="button"
                                                data-iub-enabled="1">Do not sell my personal information</button></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                    ...
                    <ul className="css-n5fyd1 e12k7apl0">
                        <li className="socialLinksItem"><a href="https://www.instagram.com/livelarq/"
                                rel="noopener noreferrer" target="_blank" title="LARQ Instagram Page"
                                className="socialLinksItemLink"><svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" aria-label="Instagram icon" role="img">
                                    <path
                        ...
                        <li className="socialLinksItem"><a href="https://www.tiktok.com/@livelarq" rel="noopener noreferrer"
                                target="_blank" title="LARQ TikTok Page" className="socialLinksItemLink"><svg width="19"
                                    height="22" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    aria-label="TikTok icon" role="img">
                                    <path
                        ...
                        <li className="socialLinksItem"><a href="https://www.youtube.com/c/LARQwater"
                                rel="noopener noreferrer" target="_blank" title="LARQ Youtube Channel"
                                className="socialLinksItemLink"><svg width="22" height="15" viewBox="0 0 22 15" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" aria-label="YouTube icon" role="img">
                                    <path
                        ...
                        <li className="socialLinksItem"><a href="https://www.facebook.com/livelarq/"
                                rel="noopener noreferrer" target="_blank" title="LARQ Facebook Page"
                                className="socialLinksItemLink"><svg width="12" height="21" viewBox="0 0 12 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" aria-label="Facebook icon" role="img">
                                    <path
    ...
    <div id="batBeacon934189192692" style="width: 0px; height: 0px; display: none; visibility: hidden;"><img
            id="batBeacon469091610205" width="0" height="0" alt=""
            src="https://bat.bing.com/action/0?ti=26016814&amp;tm=gtm002&amp;Ver=2&amp;mid=markup-adapter&amp;bo=4&amp;sid=47c78630eb3811f0832b3f9b067cc81c&amp;vid=47c79620eb3811f0a6df174f6eba1918&amp;vids=0&amp;msclkid=N&amp;uach=pv%3D10.0.0&amp;pi=918639831&amp;lg=en-US&amp;sw=1366&amp;sh=768&amp;sc=24&amp;tl=LARQ%20%7C%20Self-cleaning%20Water%20Bottle%20%7C%20As%20Seen%20on%20Shark%20Tank&amp;p=https%3A%2F%2Fwww.livelarq.com%2F&amp;r=https%3A%2F%2Fwww.livelarq.com%2F&amp;lt=5789&amp;evt=pageLoad&amp;sv=2&amp;asc=G&amp;cdb=AQAS&amp;rn=478650"
            style="width: 0px; height: 0px; display: none; visibility: hidden;" /></div><iframe height="0" width="0"
        style="display: none; visibility: hidden;"></iframe>
    <script type="text/javascript" id="" charset="">(function () {
            if (window.braze) {
                var c = google_tag_manager["rm"]["7594555"](23), d = google_tag_manager["rm"]["7594555"](24), m = google_tag_manager["rm"]["7594555"](25), b = window.braze.getUser(), a = google_tag_manager["rm"]["7594555"](26), q = google_tag_manager["rm"]["7594555"](27), e = google_tag_manager["rm"]["7594555"](28), f = void 0, n = window.braze.User.NotificationSubscriptionTypes.OPTED_IN, g = !1; c === "gtm.init" && ["eu", "ca", "uk", "us"].indexOf(d) > -1 && b.setCustomUserAttribute("store_location", d.toUpperCase()); c === "newsletterSubscription" && a.subType === "Footer" && (f = "footer", e = a.email, g = !0); c === "newsletterSubscription" && ["SOC-1",
                    "SOC-2"].indexOf(a.subType) > -1 && (f = "summer of color", e = a.email, g = !0); c === "newsletterSubscription" && a.subType === "OOS-popout" && (f = "oos", n = a.subConsent === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, e = a.email, g = !0); c === "email_subscribed" && q.source === "BCFM 2024" && (e = q.email, f = "bcfm 2024", g = !0); c === "newsletterSubscription" && a.subType === "Subscribe Landing" && (f = "subscribe landing", a.phone && (b.setPhoneNumber(a.phone),
                        b.addToSubscriptionGroup("d4fc4366-f61e-4656-9811-56c91d3b5dfe")), e = a.email, g = !0); c === "authentication" && m === "accountCreated" && (f = "account registration", n = google_tag_manager["rm"]["7594555"](29) === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : d === "us" ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, g = !0); g === !0 && (b.setEmail(e), b.setEmailNotificationSubscriptionType(n)); c === "authentication" && m === "emailUpdated" &&
