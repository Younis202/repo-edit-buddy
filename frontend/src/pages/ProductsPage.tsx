export default function ProductsPage() {
  ...
  <div id="__next" data-reactroot="">
    ...
    <main id="main-content" className="css-y8aj3r e1jq4geh0">
      <div className="css-1ij3h5v">
        <div className="css-1fc71jv ejnupyx0">
          <div className="shopBanner_promo">
            <div className="shopBanner_promo_content">
              <div className="shopBanner_promo_contentTitle">End of Year Event</div>
              <div className="shopBanner_promo_contentText">We won’t have an offer this good for a while.</div>
            </div>
            <div className="shopBanner_promo_cards">
              <div className="shopBanner_promo_cardsItem css-1eu2nsh e16frvol0">
                <div className="tierCard_title">$40 off</div>
                <div className="tierCard_note">orders $200 or more</div>
              </div>
              <div className="shopBanner_promo_cardsItem css-1eu2nsh e16frvol0">
      ...
      <div className="css-uijzor ej0yo1s0">
        <div className="css-1ftzuac">
          <div className="titleBlock css-1llzy2o">
            <div className="titleBlock_head">
                ...
                <div className="titleBlock_head_ctaContainer"><button aria-label="Open filters" type="button"
                    className="css-10mf1r3 e16l686e0" tabIndex="0"><span className="btn_icon left"><span color="text.default"
                        className="css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0" focusable="false"
                          viewBox="0 0 48 48" color="text.default" aria-hidden="true" fill="undefined">
                          <path fill="#153A5B" fill-rule="evenodd"
                            d="M29 14a4.002 4.002 0 0 1 3.874 3H36a1 1 0 1 1 0 2h-3.126a4.002 4.002 0 0 1-7.748 0H12a1 1 0 1 1 0-2h13.126c.444-1.725 2.01-3 3.874-3Zm-2 4a2 2 0 1 1 4 0 2 2 0 0 1-4 0ZM15.126 29H12a1 1 0 1 0 0 2h3.126a4.002 4.002 0 0 0 7.748 0H36a1 1 0 1 0 0-2H22.874a4.002 4.002 0 0 0-7.748 0ZM17 30a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z"
                            clip-rule="evenodd"></path>
                        </svg></span></span><span className="btn_label">Filters</span></button></div>
              </div>
            </div>
            <div className="titleBlock_text">Discover a world of brilliant hydration.</div>
          </div>
        </div>
      </div>
      ...
      <div className="css-1az2vt5 elowe8w0">
      ...
      <div className="e10esn2t0 css-ynrvca">
        <aside className="css-1hqs798 eztavj10" aria-hidden="true">
          <div role="dialog" className="css-1num8zd ep29bxd0"
            style="visibility: hidden; transform: translateX(100%) translateZ(0px);">
            <div className="filterPanel_container">
              <div className="filterPanel_main">
                <div className="filterPanel_head">
                  <div className="filterPanel_head_title">Filters</div><button className="filterPanel_head_ctaClose"
                    title="Close filters"><span color="text.default" className="btn_icon css-11qxqh7 e1dp28730"><svg
                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 48 48" color="text.default"
                        aria-hidden="true" fill="undefined">
                        <path fill="#153A5B"
                          d="M16.293 16.293a1 1 0 0 1 1.414 0L24 22.586l6.293-6.293a1 1 0 0 1 1.414 1.414L25.414 24l6.293 6.293a1 1 0 0 1-1.414 1.414L24 25.414l-6.293 6.293a1 1 0 0 1-1.414-1.414L22.586 24l-6.293-6.293a1 1 0 0 1 0-1.414Z">
                        </path>
                      </svg></span></button>
                </div>
                <div className="filterPanel_body" tabIndex="-1">
                  <div className="css-1x8typ6 e1hf5xt30">
                    ...
                    <div className="filterSection_body">
                  ...
                  <div className="css-1x8typ6 e1hf5xt30">
                    <div className="filterSection_head">
                      <div className="filterSection_headTitle">Features</div>
                    </div>
                    <div className="filterSection_body">
                      <div><label className="css-1pb0al2 evpl4cw0"
                ...
                <div className="filterPanel_footer"><button aria-label="Clear all filters" type="button"
                    className="css-8am0kh e16l686e0" disabled=""><span className="btn_label">Clear</span></button></div>
              </div>
            </div>
          </div>
        </aside>
        <main className="css-ny3n8s e1at509r0">
          <div className="css-ldun22 e7x73vv0">
            <div className="products_body">
              <div className="products_body_item">
                <div aria-label="Ho Ho H2O product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Ho Ho H2O Black / Onyx" href="/sets/ho-ho-h2o?sku=SET-BO071-FC">
                  ...
                  <div className="shopCard_content">
                    <div className="css-1fb16ks e1h8q5fr0"></div>
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/ho-ho-h2o?sku=SET-BO071-FC">
                          <h2>Ho Ho H2O</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Ho Ho H2O color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Black / Onyx" className="css-1vrknux ek6th1y0"
                                  aria-label="Select Black / Onyx color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                                          d="M21.764 11.49a.668.668 0 0 1 .079.94l-6.756 8a.667.667 0 0 1-.986.036l-3.911-4a.667.667 0 0 1 .953-.932l3.399 3.475 6.282-7.44a.667.667 0 0 1 .94-.078v-.001Z">
                                        </path>
                                      </svg></span><span color="text.default"
                                      className="swatch-icon cross css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                                        <path fill="#153A5B"
                                          d="M10.862 10.862c.26-.26.682-.26.943 0L16 15.057l4.195-4.195a.667.667 0 0 1 .943.943L16.943 16l4.195 4.195a.668.668 0 1 1-.943.943L16 16.943l-4.195 4.195a.667.667 0 0 1-.943-.943L15.057 16l-4.195-4.195a.667.667 0 0 1 0-.943Z">
                                        </path>
                                      </svg></span></span></button>
                              </div>
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Black / Pine is sold out" className="css-rrkron ek6th1y0"
                                  aria-label="Select Black / Pine color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="White / Dune" className="css-16uwv3p ek6th1y0"
                                  aria-label="Select White / Dune color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="White / Pebble is sold out" className="css-t5wst9 ek6th1y0"
                                  aria-label="Select White / Pebble color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Black / Onyx</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Ho Ho H2O size"><button type="button"
                            className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 24 oz size">24
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 32 oz size">32 oz</button></div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $101.10 instead of $118.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$118.95</span> <span
                            className="priceCurrent" aria-hidden="true">$101.10</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Santa’s Little Sipper product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1cj8om4 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Santa’s Little Sipper Monaco Blue"
                      href="/sets/santas-little-sipper?sku=SET-MB74-AL-TS">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/santas-little-sipper?sku=SET-MB74-AL-TS">
                          <h2>Santa’s Little Sipper</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-backface-hidden swiper-initialized swiper-horizontal swiper-free-mode">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Santa’s Little Sipper color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-dk8zb3 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Seaside Mint is sold out" className="css-1t18tmr ek6th1y0"
                                  aria-label="Select Seaside Mint color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Monaco Blue</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Santa’s Little Sipper size"><button
                            type="button" className="css-fajmj4 e1sc3p7b0" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-1bnu34p e1sc3p7b0"
                            aria-label="Select 25 oz size" disabled="">25 oz</button></div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $118.10 instead of $127.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$127</span> <span
                            className="priceCurrent" aria-hidden="true">$118.10</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Hydration, Served product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-ktbb9c et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Hydration, Served Eucalyptus Green"
                      href="/sets/hydration-served?sku=SET-EG68-PL">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/hydration-served?sku=SET-EG68-PL">
                          <h2>Hydration, Served</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Hydration, Served color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black is sold out" className="css-1xfs2ko ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Eucalyptus Green" className="css-10037kw ek6th1y0"
                                  aria-label="Select Eucalyptus Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Granite White" className="css-10sdqrl ek6th1y0"
                                  aria-label="Select Granite White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Mojave Dune is sold out" className="css-1rv485k ek6th1y0"
                                  aria-label="Select Mojave Dune color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Luberon Lavender is sold out" className="css-mnvc6h ek6th1y0"
                                  aria-label="Select Luberon Lavender color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amalfi Blue" className="css-j5fss5 ek6th1y0" aria-label="Select Amalfi Blue color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                                        <path fill="#153A5B"
                                          d="M21.764 11.49a.668.668 0 0 1 .079.94l-6.756 8a.667.667 0 0 1-.986.036l-3.911-4a.667.667 0 0 1 .953-.932l3.399 3.475 6.282-7.44a.667.667 0 0 1 .94-.078v-.001Z">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Eucalyptus Green</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Hydration, Served size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Nano Zero</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $109.60 instead of $128.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$128.95</span> <span
                            className="priceCurrent" aria-hidden="true">$109.60</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Yule Be Sippin’ product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Yule Be Sippin’ Obsidian Black" href="/sets/yule-be-sippin?sku=SET-OB50-FC">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/yule-be-sippin?sku=SET-OB50-FC">
                          <h2>Yule Be Sippin’</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Yule Be Sippin’ color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Granite White is sold out" className="css-10sdqrl ek6th1y0"
                                  aria-label="Select Granite White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Seaside Mint" className="css-1t18tmr ek6th1y0"
                                  aria-label="Select Seaside Mint color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Yule Be Sippin’ size"><button type="button"
                            className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 25 oz size">25 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Self cleaning, Filtration</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $118.70 instead of $124.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$124.95</span> <span
                            className="priceCurrent" aria-hidden="true">$118.70</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Sleigh the Sip product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Sleigh the Sip Obsidian Black" href="/sets/sleigh-the-sip?sku=SET-OB68-HN-OB">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    <div className="css-vjf8qf e1h8q5fr0">
                      <div>Sold out</div>
                    </div>
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/sleigh-the-sip?sku=SET-OB68-HN-OB">
                          <h2>Sleigh the Sip</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Sleigh the Sip color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black is sold out" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Eucalyptus Green is sold out" className="css-vxiyz9 ek6th1y0"
                                  aria-label="Select Eucalyptus Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Sleigh the Sip size"><button type="button"
                            className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Hydration tracking, Filtration, Purification</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $136.80 instead of $152.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$152</span> <span
                            className="priceCurrent" aria-hidden="true">$136.80</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle PureVis™ 2 product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle PureVis™ 2 Obsidian Black"
                      href="/purification/larq-bottle-purevis-2?sku=BWOB068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    <div className="css-65fedf e1h8q5fr0">
                      <div>New</div>
                    </div>
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/purification/larq-bottle-purevis-2?sku=BWOB068A">
                          <h2>LARQ Bottle PureVis™ 2</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle PureVis™ 2 color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Mojave Dune" className="css-1rv485k ek6th1y0" aria-label="Select Mojave Dune color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Eucalyptus Green" className="css-vxiyz9 ek6th1y0"
                                  aria-label="Select Eucalyptus Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Luberon Lavender" className="css-mnvc6h ek6th1y0"
                                  aria-label="Select Luberon Lavender color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Arctic Blue is sold out" className="css-9ibjn6 ek6th1y0"
                                  aria-label="Select Arctic Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Juniper Green is sold out" className="css-14bm2j8 ek6th1y0"
                                  aria-label="Select Juniper Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle PureVis™ 2 size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Hydration tracking, Self cleaning, Filtration</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $129.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$129</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Filtered Swig Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-ktbb9c et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Filtered Swig Top Eucalyptus Green"
                      href="/purification/larq-bottle-filtered-swig-top?sku=BFBNWEG068ABFAW068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/purification/larq-bottle-filtered-swig-top?sku=BFBNWEG068ABFAW068A">
                          <h2>LARQ Bottle Filtered Swig Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle Filtered Swig Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Eucalyptus Green is sold out" className="css-10037kw ek6th1y0"
                                  aria-label="Select Eucalyptus Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Obsidian Black is sold out" className="css-1xfs2ko ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amber Vittoria Obsidian Black is sold out" className="css-1n6yi8y ek6th1y0"
                                  aria-label="Select Amber Vittoria Obsidian Black color" type="button"><span
                                    className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amber Vittoria Granite White is sold out" className="css-87hp79 ek6th1y0"
                                  aria-label="Select Amber Vittoria Granite White color" type="button"><span
                                    className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amalfi Blue is sold out" className="css-j5fss5 ek6th1y0"
                                  aria-label="Select Amalfi Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Arctic Blue is sold out" className="css-zoei5r ek6th1y0"
                                  aria-label="Select Arctic Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Eucalyptus Green</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Filtered Swig Top size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $49.95 instead of $55.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$55</span> <span
                            className="priceCurrent" aria-hidden="true">$49.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle PureVis™ product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1cj8om4 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle PureVis™ Monaco Blue"
                      href="/purification/larq-bottle-purevis?sku=BDMB074A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                    ...
                    <div className="shopCard_content_body">
                      ...
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-backface-hidden swiper-initialized swiper-horizontal swiper-free-mode">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle PureVis™ color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-dk8zb3 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Monaco Blue</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle PureVis™ size"><button
                            type="button" className="css-fajmj4 e1sc3p7b0" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-1bnu34p e1sc3p7b0"
                            aria-label="Select 25 oz size" disabled="">25 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Self cleaning</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $109.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$109</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Movement PureVis™ product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Movement PureVis™ Black / Onyx"
                      href="/purification/larq-bottle-purevis?sku=BSBO071A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/purification/larq-bottle-purevis?sku=BSBO071A">
                          <h2>LARQ Bottle Movement PureVis™</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle Movement PureVis™ color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Black / Pine is sold out" className="css-rrkron ek6th1y0"
                                  aria-label="Select Black / Pine color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Black / Onyx" className="css-1vrknux ek6th1y0"
                                  aria-label="Select Black / Onyx color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="White / Coral is sold out" className="css-jwk6d5 ek6th1y0"
                                  aria-label="Select White / Coral color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Black / Vert is sold out" className="css-198zpe3 ek6th1y0"
                                  aria-label="Select Black / Vert color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="White / Marine is sold out" className="css-np76yu ek6th1y0"
                                  aria-label="Select White / Marine color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Black / Onyx</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Movement PureVis™ size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 24 oz size">24
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 32 oz size">32 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $89.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$89</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Pitcher PureVis™ product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-67y418 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Pitcher PureVis™ Monaco Blue"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/home/larq-pitcher-purevis?sku=PAMB190A">
                          <h2>LARQ Pitcher PureVis™</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Pitcher PureVis™ color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-r3dbs5 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Pure White" className="css-17l4mkp ek6th1y0" aria-label="Select Pure White color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $139.00 instead of $168.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$168</span> <span
                            className="priceCurrent" aria-hidden="true">$139</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Swig Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Swig Top Obsidian Black"
                      href="/drinkware/larq-bottle-swig-top?sku=BNWOB100A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/drinkware/larq-bottle-swig-top?sku=BNWOB100A">
                          <h2>LARQ Bottle Swig Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle Swig Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amber Vittoria Obsidian Black" className="css-1n6yi8y ek6th1y0"
                                  aria-label="Select Amber Vittoria Obsidian Black color" type="button"><span
                                    className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Amber Vittoria Granite White" className="css-87hp79 ek6th1y0"
                                  aria-label="Select Amber Vittoria Granite White color" type="button"><span
                                    className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Arctic Blue" className="css-zoei5r ek6th1y0" aria-label="Select Arctic Blue color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Juniper Green" className="css-14bm2j8 ek6th1y0"
                                  aria-label="Select Juniper Green color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Swig Top size"><button
                            type="button" className="css-fajmj4 e1sc3p7b0" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-1bnu34p e1sc3p7b0"
                            aria-label="Select 34 oz size" disabled="">34 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Everyday drinkware</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $49.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$49.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Pitcher product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-67y418 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Pitcher Monaco Blue" href="/home/larq-pitcher?sku=PNAMB190B">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/home/larq-pitcher?sku=PNAMB190B">
                          <h2>LARQ Pitcher</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Pitcher color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-r3dbs5 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $69.00 instead of $89.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$89</span> <span
                            className="priceCurrent" aria-hidden="true">$69</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Thirst Trap-mas product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Thirst Trap-mas Obsidian Black"
                      href="/sets/thirst-trap-mas?sku=SET-OB68-HN-OB-F">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/sets/thirst-trap-mas?sku=SET-OB68-HN-OB-F">
                          <h2>Thirst Trap-mas</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Thirst Trap-mas color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black is sold out" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Thirst Trap-mas size"><button type="button"
                            className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $83.60 instead of $92.90</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$92.90</span> <span
                            className="priceCurrent" aria-hidden="true">$83.60</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Movement Filtered Flip Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1dmw8 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Movement Filtered Flip Top White / Pebble"
                      href="/purification/larq-bottle-filtered-flip-top?sku=BFSWP095A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/purification/larq-bottle-filtered-flip-top?sku=BFSWP095A">
                          <h2>LARQ Bottle Movement Filtered Flip Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle Movement Filtered Flip Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="White / Pebble" className="css-1ov29bo ek6th1y0"
                                  aria-label="Select White / Pebble color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Black / Onyx" className="css-1vnak06 ek6th1y0"
                                  aria-label="Select Black / Onyx color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>White / Pebble</span></div>
                        <div className="css-8w8d45 e7c9lfa0"
                          aria-label="Select LARQ Bottle Movement Filtered Flip Top size"><button type="button"
                            className="css-fajmj4 e1sc3p7b0" aria-label="Select 24 oz size">24 oz</button><button
                            type="button" className="css-1bnu34p e1sc3p7b0" aria-label="Select 32 oz size" disabled="">32
                            oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Filtration</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $54.95 instead of $65.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$65</span> <span
                            className="priceCurrent" aria-hidden="true">$54.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Filtered Flip Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1ryxl2a et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Filtered Flip Top Granite White"
                      href="/purification/larq-bottle-filtered-flip-top?sku=BFDGW050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/purification/larq-bottle-filtered-flip-top?sku=BFDGW050A">
                          <h2>LARQ Bottle Filtered Flip Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle Filtered Flip Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Granite White" className="css-c3f9jy ek6th1y0"
                                  aria-label="Select Granite White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Obsidian Black" className="css-1xfs2ko ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Granite White</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Filtered Flip Top size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 25 oz size">25 oz</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $55.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$55</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Flip Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Flip Top Obsidian Black"
                      href="/drinkware/larq-bottle-flip-top?sku=BNSOB050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/drinkware/larq-bottle-flip-top?sku=BNSOB050A">
                          <h2>LARQ Bottle Flip Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle Flip Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Obsidian Black</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Flip Top size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 25 oz size">25 oz</button></div>
                      </div>
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $39.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$39.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Twist Top product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1cj8om4 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Twist Top Monaco Blue"
                      href="/drinkware/larq-bottle-twist-top?sku=BNDMB050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/drinkware/larq-bottle-twist-top?sku=BNDMB050A">
                          <h2>LARQ Bottle Twist Top</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle Twist Top color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-dk8zb3 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Himalayan Pink" className="css-1rbo0kz ek6th1y0"
                                  aria-label="Select Himalayan Pink color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Monaco Blue</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Twist Top size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 17 oz size">17
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 25 oz size">25 oz</button></div>
                      </div>
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $29.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$29.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="css-ldun22 e7x73vv0">
            <div className="products_head">
              <div className="css-uijzor ej0yo1s0">
                <div className="css-1wfujb1">
                  <div className="titleBlock css-1llzy2o">
                    <div className="titleBlock_head">
                      <h2 className="titleBlock_head_title">Accessories</h2>
                    </div>
                    <div className="titleBlock_text">Customize your on-the-go hydration with accessories.</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="products_body">
              <div className="products_body_item">
                <div aria-label="Advanced Pitcher Filter product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-v1o2v3 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Advanced Pitcher Filter " href="/accessories/larq-pitcher-filter?sku=PAFR190A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-pitcher-filter?sku=PAFR190A">
                          <h2>Advanced Pitcher Filter</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Advanced Pitcher Filter color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button className="css-1shqc6h ek6th1y0" aria-label="Select undefined color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Advanced Pitcher Filter size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled=""
                            aria-label="Select single size">Single</button><button type="button"
                            className="css-fajmj4 e1sc3p7b0" aria-label="Select three pack size">Three pack</button></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Nano Zero</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $27.50 instead of $32.50</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$32.50</span> <span
                            className="priceCurrent" aria-hidden="true">$27.50</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Essential Pitcher Filter product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Essential Pitcher Filter " href="/accessories/larq-pitcher-filter?sku=PEFR190A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-pitcher-filter?sku=PEFR190A">
                          <h2>Essential Pitcher Filter</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Essential Pitcher Filter color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button className="css-1shqc6h ek6th1y0" aria-label="Select undefined color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Essential Pitcher Filter size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled=""
                            aria-label="Select single size">Single</button><button type="button"
                            className="css-fajmj4 e1sc3p7b0" aria-label="Select three pack size">Three pack</button></div>
                      </div>
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $22.50 instead of $24.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$24.95</span> <span
                            className="priceCurrent" aria-hidden="true">$22.50</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Advanced Bottle Filter product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Advanced Bottle Filter " href="/accessories/bottle-filter?sku=BFRF050A3">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/bottle-filter?sku=BFRF050A3">
                          <h2>Advanced Bottle Filter</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Advanced Bottle Filter color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button className="css-1shqc6h ek6th1y0" aria-label="Select undefined color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Three pack</span></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Nano Zero</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $39.95 instead of $49.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$49.95</span> <span
                            className="priceCurrent" aria-hidden="true">$39.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Essential Bottle Filter product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Essential Bottle Filter " href="/accessories/bottle-filter?sku=BFEF050A-3">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/bottle-filter?sku=BFEF050A-3">
                          <h2>Essential Bottle Filter</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Essential Bottle Filter color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button className="css-1shqc6h ek6th1y0" aria-label="Select undefined color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $29.95 instead of $35.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$35</span> <span
                            className="priceCurrent" aria-hidden="true">$29.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Filter Straw product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Filter Straw Pure White" href="/accessories/larq-filter-straw?sku=BFAW068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-filter-straw?sku=BFAW068A">
                          <h2>LARQ Filter Straw</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Filter Straw color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Pure White is sold out" className="css-1jw2lz7 ek6th1y0"
                                  aria-label="Select Pure White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Pure White</span></div>
                      </div>
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Filtration</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $15.95 instead of $19.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$19.95</span> <span
                            className="priceCurrent" aria-hidden="true">$15.95</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Filtered Cap product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Filtered Cap Obsidian Black"
                      href="/accessories/larq-bottle-filtered-cap?sku=BFCOB050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-bottle-filtered-cap?sku=BFCOB050A">
                          <h2>LARQ Bottle Filtered Cap</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle Filtered Cap color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $25.00 instead of $29.95</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceOld" aria-hidden="true">$29.95</span> <span
                            className="priceCurrent" aria-hidden="true">$25</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle PureVis™ 2 Cap product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle PureVis™ 2 Cap Obsidian Black"
                      href="/accessories/larq-bottle-purevis-2-cap?sku=BCOB068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-bottle-purevis-2-cap?sku=BCOB068A">
                          <h2>LARQ Bottle PureVis™ 2 Cap</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle PureVis™ 2 Cap color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Obsidian Black" className="css-16unhe5 ek6th1y0"
                                  aria-label="Select Obsidian Black color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="shopCard_quickInfo css-1iu0ln ebshcfk0">
                        <div>Hydration tracking, Purification</div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $79.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$79</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle PureVis™ Cap product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1cj8om4 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle PureVis™ Cap Monaco Blue"
                      href="/accessories/larq-bottle-purevis-cap?sku=BCMB050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-bottle-purevis-cap?sku=BCMB050A">
                          <h2>LARQ Bottle PureVis™ Cap</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Bottle PureVis™ Cap color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-dk8zb3 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Electro Blue is sold out" className="css-i0hy9v ek6th1y0"
                                  aria-label="Select Electro Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $59.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$59</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Straws &amp; Adaptors Pack product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Straws &amp; Adaptors Pack Pure White"
                      href="/accessories/straws-and-adaptors-pack?sku=BASA068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      ...
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select Straws &amp; Adaptors Pack color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Pure White" className="css-1jw2lz7 ek6th1y0"
                                  aria-label="Select Pure White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $9.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$9</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Cap Cleaning Brush product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-67y418 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Cap Cleaning Brush Monaco Blue"
                      href="/accessories/cap-cleaning-brush?sku=BACCBMBA">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/cap-cleaning-brush?sku=BACCBMBA">
                          <h2>Cap Cleaning Brush</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Cap Cleaning Brush color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Monaco Blue" className="css-r3dbs5 ek6th1y0"
                                  aria-label="Select Monaco Blue color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="css-wn1ko exv7rs90">Starting at $8.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$8</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Travel Sleeve product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-qc3vsu et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Travel Sleeve Granite White" href="/accessories/travel-sleeve?sku=SHG050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/travel-sleeve?sku=SHG050A">
                          <h2>Travel Sleeve</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Travel Sleeve color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Granite White" className="css-jfdzpp ek6th1y0"
                                  aria-label="Select Granite White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Granite White</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select Travel Sleeve size"><button type="button"
                            className="css-1bnu34p e1sc3p7b0" disabled=""
                            aria-label="Select medium size">Medium</button><button type="button"
                            className="css-fajmj4 e1sc3p7b0" aria-label="Select large size">Large</button></div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $18.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$18</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Silicone Boot product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1ryxl2a et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Silicone Boot Granite White"
                      href="/accessories/larq-silicone-boot?sku=SBGW068A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-silicone-boot?sku=SBGW068A">
                          <h2>LARQ Silicone Boot</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Silicone Boot color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Granite White" className="css-c3f9jy ek6th1y0"
                                  aria-label="Select Granite White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Granite White</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Silicone Boot size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 23 oz size">23
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 34 oz size">34 oz</button></div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $15.00</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$15</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Nomatic Navigator Sling 1L product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-1h3l8o8 et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Nomatic Navigator Sling 1L Black"
                      href="/accessories/nomatic-navigator-sling?sku=NVSL01-BLK-01">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    <div className="css-1fb16ks e1h8q5fr0">
                      <div>Limited edition</div>
                    </div>
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/nomatic-navigator-sling?sku=NVSL01-BLK-01">
                          <h2>Nomatic Navigator Sling 1L</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select Nomatic Navigator Sling 1L color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Black" className="css-1ax630d ek6th1y0" aria-label="Select Black color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Black</span></div>
                      </div>
                      <div className="css-wn1ko exv7rs90">Starting at $79.99</div>
                      <div className="css-cdckcp exbswh30" aria-hidden="true">
                        <div className="priceContainer"><span className="priceCurrent" aria-hidden="true">$79.99</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="products_body_item">
                <div aria-label="Active Loop product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Active Loop Black" href="/accessories/active-loop?sku=SLOB050A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/active-loop?sku=SLOB050A">
                          <h2>Active Loop</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Active Loop color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Black" className="css-16unhe5 ek6th1y0" aria-label="Select Black color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="White" className="css-17l4mkp ek6th1y0" aria-label="Select White color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Bottle Movement Sleeve product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-12r791o et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Bottle Movement Sleeve Coral"
                      href="/accessories/larq-bottle-movement-sleeve?sku=SSC071A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-bottle-movement-sleeve?sku=SSC071A">
                          <h2>LARQ Bottle Movement Sleeve</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper"
                              aria-label="Select LARQ Bottle Movement Sleeve color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Coral" className="css-1jbyzic ek6th1y0" aria-label="Select Coral color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item swiper-slide-next" style="margin-right: 8px;"><button
                                  title="Marine is sold out" className="css-www5c5 ek6th1y0"
                                  aria-label="Select Marine color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
                                        className="css-82n8sf e11de7sb0" focusable="false" viewBox="0 0 32 32"
                                        color="text.default" aria-hidden="true" fill="undefined">
                                        <path fill="#153A5B"
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button
                                  title="Onyx is sold out" className="css-1xfs2ko ek6th1y0" aria-label="Select Onyx color"
                                  type="button"><span className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                              ...
                              <div className="colorsPickerSwiper_item" style="margin-right: 8px;"><button title="Vert"
                                  className="css-yqelzb ek6th1y0" aria-label="Select Vert color" type="button"><span
                                    className="swatch"><span color="text.default"
                                      className="swatch-icon check css-11qxqh7 e1dp28730"><svg className="css-82n8sf e11de7sb0"
                                        focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true"
                                        fill="undefined">
                      ...
                      <div className="shopCard_variantsInfo">
                        <div className="css-1mb10vo eglraj20"><span>Coral</span></div>
                        <div className="css-8w8d45 e7c9lfa0" aria-label="Select LARQ Bottle Movement Sleeve size"><button
                            type="button" className="css-1bnu34p e1sc3p7b0" disabled="" aria-label="Select 24 oz size">24
                            oz</button><button type="button" className="css-fajmj4 e1sc3p7b0"
                            aria-label="Select 32 oz size">32 oz</button></div>
                      </div>
              ...
              <div className="products_body_item">
                <div aria-label="LARQ Magnetic Charger product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View LARQ Magnetic Charger Pure White"
                      href="/accessories/larq-magnetic-charger?sku=CMW091A">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/larq-magnetic-charger?sku=CMW091A">
                          <h2>LARQ Magnetic Charger</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select LARQ Magnetic Charger color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Pure White" className="css-1jw2lz7 ek6th1y0"
                                  aria-label="Select Pure White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
              ...
              <div className="products_body_item">
                <div aria-label="USB-C Cable product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View USB-C Cable Pure White" href="/accessories/usb-c-cable?sku=USBC055W">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/usb-c-cable?sku=USBC055W">
                          <h2>USB-C Cable</h2>
                        </a></div>
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select USB-C Cable color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Pure White" className="css-1jw2lz7 ek6th1y0"
                                  aria-label="Select Pure White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
              ...
              <div className="products_body_item">
                <div aria-label="Micro-USB Cable product" className="css-14upggb eoes6mn0">
                  <div className="css-11j2dj0 e1aghnsr0">
                    <div className="css-15gsjkl et5ovjm0"></div><a className="productMedia_wrap isLink"
                      aria-label="View Micro-USB Cable Pure White" href="/accessories/micro-usb-cable?sku=USBM055W">
                      <div className="productMedia">
                        <div className="productMedia_asset"><img className="productMedia_assetImage"
                  ...
                  <div className="shopCard_content">
                    ...
                    <div className="shopCard_content_body">
                      <div className="css-1wuezs8 eoz2ert0"><a className="productTitle isLink"
                          href="/accessories/micro-usb-cable?sku=USBM055W">
                      ...
                      <div className="shopCard_colorsPicker">
                        <div className="shopCard_colorsPicker_colors css-108xz3x e17jh5ji0">
                          <div
                            className="colorsPickerSwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
                            <div className="colorsPickerSwiper_wrapper" aria-label="Select Micro-USB Cable color">
                              <div className="colorsPickerSwiper_item swiper-slide-active" style="margin-right: 8px;">
                                <button title="Pure White" className="css-1jw2lz7 ek6th1y0"
                                  aria-label="Select Pure White color" type="button"><span className="swatch"><span
                                      color="text.default" className="swatch-icon check css-11qxqh7 e1dp28730"><svg
  ...
  <script type="text/javascript" id="" charset="">(function () {
      if (window.braze) {
        var c = google_tag_manager["rm"]["7594555"](31), d = google_tag_manager["rm"]["7594555"](32), m = google_tag_manager["rm"]["7594555"](33), b = window.braze.getUser(), a = google_tag_manager["rm"]["7594555"](34), q = google_tag_manager["rm"]["7594555"](35), e = google_tag_manager["rm"]["7594555"](36), f = void 0, n = window.braze.User.NotificationSubscriptionTypes.OPTED_IN, g = !1; c === "gtm.init" && ["eu", "ca", "uk", "us"].indexOf(d) > -1 && b.setCustomUserAttribute("store_location", d.toUpperCase()); c === "newsletterSubscription" && a.subType === "Footer" && (f = "footer", e = a.email, g = !0); c === "newsletterSubscription" && ["SOC-1",
          "SOC-2"].indexOf(a.subType) > -1 && (f = "summer of color", e = a.email, g = !0); c === "newsletterSubscription" && a.subType === "OOS-popout" && (f = "oos", n = a.subConsent === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, e = a.email, g = !0); c === "email_subscribed" && q.source === "BCFM 2024" && (e = q.email, f = "bcfm 2024", g = !0); c === "newsletterSubscription" && a.subType === "Subscribe Landing" && (f = "subscribe landing", a.phone && (b.setPhoneNumber(a.phone),
            b.addToSubscriptionGroup("d4fc4366-f61e-4656-9811-56c91d3b5dfe")), e = a.email, g = !0); c === "authentication" && m === "accountCreated" && (f = "account registration", n = google_tag_manager["rm"]["7594555"](37) === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : d === "us" ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, g = !0); g === !0 && (b.setEmail(e), b.setEmailNotificationSubscriptionType(n)); c === "authentication" && m === "emailUpdated" &&
  ...
  <script type="text/javascript" id="" charset="">(function () {
      if (window.braze) {
        var c = google_tag_manager["rm"]["7594555"](55), d = google_tag_manager["rm"]["7594555"](56), m = google_tag_manager["rm"]["7594555"](57), b = window.braze.getUser(), a = google_tag_manager["rm"]["7594555"](58), q = google_tag_manager["rm"]["7594555"](59), e = google_tag_manager["rm"]["7594555"](60), f = void 0, n = window.braze.User.NotificationSubscriptionTypes.OPTED_IN, g = !1; c === "gtm.init" && ["eu", "ca", "uk", "us"].indexOf(d) > -1 && b.setCustomUserAttribute("store_location", d.toUpperCase()); c === "newsletterSubscription" && a.subType === "Footer" && (f = "footer", e = a.email, g = !0); c === "newsletterSubscription" && ["SOC-1",
          "SOC-2"].indexOf(a.subType) > -1 && (f = "summer of color", e = a.email, g = !0); c === "newsletterSubscription" && a.subType === "OOS-popout" && (f = "oos", n = a.subConsent === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, e = a.email, g = !0); c === "email_subscribed" && q.source === "BCFM 2024" && (e = q.email, f = "bcfm 2024", g = !0); c === "newsletterSubscription" && a.subType === "Subscribe Landing" && (f = "subscribe landing", a.phone && (b.setPhoneNumber(a.phone),
            b.addToSubscriptionGroup("d4fc4366-f61e-4656-9811-56c91d3b5dfe")), e = a.email, g = !0); c === "authentication" && m === "accountCreated" && (f = "account registration", n = google_tag_manager["rm"]["7594555"](61) === !0 && ["eu", "uk", "ca"].indexOf(d) > -1 ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : d === "us" ? window.braze.User.NotificationSubscriptionTypes.OPTED_IN : window.braze.User.NotificationSubscriptionTypes.SUBSCRIBED, g = !0); g === !0 && (b.setEmail(e), b.setEmailNotificationSubscriptionType(n)); c === "authentication" && m === "emailUpdated" &&
              b.setEmail(e); b.setCustomUserAttribute("signup_source", f); c = document.referrer; d = document.location.href; m = function () { var k = document.location.search; if (k.length !== 0) { k = k.slice(1); var p = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"], l = "?"; k.split("\x26").forEach(function (h) { p.indexOf(h.split("\x3d")[0]) > -1 && (l += h + "\x26") }); return l === "?" ? null : l.slice(0, -1) } }; a = function (k) {
                var p = document.cookie.split("; "), l = null; p.forEach(function (h) {
                  var r = h.split("\x3d")[0]; h = h.split("\x3d")[1];
                  r === k && (l = h)
  ...
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/56233f02-f87ee34e28451509.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2977-461e5267e5a3a6bd.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2881-801f236c32513633.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2560-6e66bec6152b4a8c.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/3598-7c7ddd051b56d7e0.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2228-4f3ce09f118b33a6.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/9128-ecc549da54f1d0dd.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/6728-87c566f0467f3fb0.js"></script>
  <script
    src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/purification/larq-bottle-purevis-2-4609625cf2e8daf2.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/8387-1b5f708511a6578f.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/5485-82cbdd2cf3867c47.js"></script>
  <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/4342-733cb4d431f5e63f.js"></script>
  <script
    src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/accessories/larq-pitcher-filter-ecd05788877e9076.js"></script>
  <script
    src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/accessories/larq-bottle-filtered-cap-009da41f4705d851.js"></script>
  <script
    src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/accessories/active-loop-1a85cfaa01a93edd.js"></script>
  <script
