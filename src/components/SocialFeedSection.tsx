...
import lookbook3 from "@/assets/social.png";
import craftsmanship1 from "@/assets/omar3.jpg";
      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-5">
            ...
            <p className="text-[11px] tracking-wide text-muted-foreground font-body">
              @shathaya
            </p>
          </div>
          <h2 className="font-display text-4xl md:text-6xl font-light text-foreground leading-[0.95]">
            تابع <span className="italic">الرحلة</span>
          </h2>
        </div>
        <a
          href="#"
          className="mt-6 md:mt-0 inline-flex items-center gap-3 text-[11px] tracking-wide text-foreground/50 hover:text-accent transition-colors duration-500 font-body group"
        >
          <span>تابعنا</span>
          <ArrowUpLeft
            size={12}
