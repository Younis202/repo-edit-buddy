...
export const allProducts: Product[] = [
  { id: 1, slug: "oud-royal", name: "عود ملكي", nameItalic: "ملكي", price: "٤,٢٥٠ ج.م", originalPrice: "٥,٢٥٠ ج.م", category: "عود", tag: "الأكثر مبيعاً", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["oud-royal"], colors: defaultColors, shortDescription: "عود ملكي فاخر مستخلص من أجود أنواع خشب العود الكمبودي.", material: "عود كمبودي طبيعي", season: "٢٠٢٦", accordion: defaultAccordion("عود ملكي", "خشب العود الكمبودي", "القاهرة"), defaultBottle: "square-gold", availableBottles: ["square-gold", "cylinder-black", "dome-black"] },
  { id: 2, slug: "ward-taifi", name: "ورد طائفي", nameItalic: "طائفي", price: "٣,٢٥٠ ج.م", category: "زهري", tag: "جديد", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["ward-taifi"], colors: [{ name: "وردي", value: "hsl(340, 40%, 65%)" }, { name: "ذهبي", value: "hsl(42, 60%, 55%)" }], shortDescription: "عطر ورد طائفي أصيل.", material: "ورد طائفي طبيعي", season: "٢٠٢٦", accordion: defaultAccordion("ورد طائفي", "ورد طائفي أصيل", "القاهرة"), defaultBottle: "cube-rosegold", availableBottles: ["cube-rosegold", "teardrop-blue", "square-gold"] },
  { id: 3, slug: "misk-aswad", name: "مسك أسود", nameItalic: "أسود", price: "٤,٧٥٠ ج.م", category: "مسك", tag: "الأكثر مبيعاً", sizes: ["٣٠ مل", "٥٠ مل"], images: productGalleryImages["misk-aswad"], colors: [{ name: "أسود", value: "hsl(40, 5%, 8%)" }], shortDescription: "مسك أسود نادر.", material: "مسك أسود نادر", season: "٢٠٢٦", accordion: defaultAccordion("مسك أسود", "مسك أسود", "القاهرة"), defaultBottle: "cylinder-black", availableBottles: ["cylinder-black", "dome-black", "slim-gold"] },
  { id: 4, slug: "amber-nights", name: "ليالي العنبر", nameItalic: "العنبر", price: "٣,٧٥٠ ج.م", category: "شرقي", tag: "محدود", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["amber-nights"], colors: [{ name: "عنبر", value: "hsl(35, 40%, 35%)" }], shortDescription: "عطر شرقي فاخر.", material: "عنبر طبيعي", season: "٢٠٢٦", accordion: defaultAccordion("ليالي العنبر", "العنبر الطبيعي", "القاهرة"), defaultBottle: "square-gold", availableBottles: ["square-gold", "cube-rosegold", "slim-gold"] },
  { id: 5, slug: "bukhoor-elite", name: "بخور النخبة", nameItalic: "النخبة", price: "٢,٧٥٠ ج.م", category: "بخور", tag: "رائج", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["bukhoor-elite"], colors: defaultColors, shortDescription: "بخور سائل فاخر.", material: "خلطة بخور فاخرة", season: "٢٠٢٦", accordion: defaultAccordion("بخور النخبة", "خلطة بخور", "القاهرة"), defaultBottle: "dome-black", availableBottles: ["dome-black", "cylinder-black", "square-gold"] },
  { id: 6, slug: "zaafaran-gold", name: "زعفران ذهبي", nameItalic: "ذهبي", price: "٢,٤٠٠ ج.م", category: "شرقي", tag: "عاد للمخزون", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["zaafaran-gold"], colors: [{ name: "ذهبي", value: "hsl(42, 60%, 55%)" }], shortDescription: "عطر بنفحات الزعفران.", material: "زعفران إيراني", season: "٢٠٢٦", accordion: defaultAccordion("زعفران ذهبي", "زعفران إيراني", "القاهرة"), defaultBottle: "cube-rosegold", availableBottles: ["cube-rosegold", "square-gold", "slim-gold"] },
  { id: 7, slug: "jasmine-blanc", name: "ياسمين أبيض", nameItalic: "أبيض", price: "٢,١٠٠ ج.م", category: "زهري", tag: "جديد", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["jasmine-blanc"], colors: [{ name: "أبيض", value: "hsl(0, 0%, 95%)" }], shortDescription: "ياسمين أبيض نقي.", material: "ياسمين دمشقي", season: "٢٠٢٦", accordion: defaultAccordion("ياسمين أبيض", "ياسمين دمشقي", "القاهرة"), defaultBottle: "teardrop-blue", availableBottles: ["teardrop-blue", "cube-rosegold", "dome-black"] },
  { id: 8, slug: "oud-supreme", name: "عود سوبريم", nameItalic: "سوبريم", price: "٦,٠٠٠ ج.م", category: "عود", tag: "جديد", sizes: ["٣٠ مل", "٥٠ مل"], images: productGalleryImages["oud-supreme"], colors: defaultColors, shortDescription: "أفخم أنواع العود المعتّق.", material: "عود هندي معتّق", season: "٢٠٢٦", accordion: defaultAccordion("عود سوبريم", "عود هندي معتّق", "القاهرة"), defaultBottle: "square-gold", availableBottles: ["square-gold", "cube-rosegold", "cylinder-black"] },
  { id: 9, slug: "misk-tahara", name: "مسك الطهارة", nameItalic: "الطهارة", price: "١,٦٠٠ ج.م", category: "مسك", tag: "الأكثر مبيعاً", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["misk-tahara"], colors: [{ name: "أبيض", value: "hsl(0, 0%, 95%)" }], shortDescription: "مسك الطهارة الأصيل.", material: "مسك طبيعي نقي", season: "٢٠٢٦", accordion: defaultAccordion("مسك الطهارة", "مسك أبيض", "القاهرة"), defaultBottle: "dome-black", availableBottles: ["dome-black", "cylinder-black", "slim-gold"] },
  { id: 10, slug: "sandal-hind", name: "صندل هندي", nameItalic: "هندي", price: "٢,٩٠٠ ج.م", category: "خشبي", tag: "جديد", sizes: ["٣٠ مل", "٥٠ مل", "١٠٠ مل"], images: productGalleryImages["sandal-hind"], colors: [{ name: "بيج", value: "hsl(35, 30%, 70%)" }], shortDescription: "خشب الصندل الهندي الأصيل.", material: "صندل هندي ميسوري", season: "٢٠٢٦", accordion: defaultAccordion("صندل هندي", "خشب الصندل", "القاهرة"), defaultBottle: "cylinder-black", availableBottles: ["cylinder-black", "square-gold", "dome-black"] },
  { id: 11, slug: "dehn-ward", name: "دهن ورد", nameItalic: "ورد", price: "٣,٩٠٠ ج.م", category: "زهري", tag: "رائج", sizes: ["٣ مل", "٦ مل", "١٢ مل"], images: productGalleryImages["dehn-ward"], colors: [{ name: "وردي غامق", value: "hsl(340, 50%, 40%)" }], shortDescription: "دهن ورد طائفي مركّز.", material: "دهن ورد طائفي", season: "٢٠٢٦", accordion: defaultAccordion("دهن ورد", "دهن ورد", "القاهرة"), defaultBottle: "slim-gold", availableBottles: ["slim-gold", "teardrop-blue", "cube-rosegold"] },
  { id: 12, slug: "layali-sharqiya", name: "ليالي شرقية", nameItalic: "شرقية", price: "٤,٤٥٠ ج.م", originalPrice: "٥,٥٠٠ ج.م", category: "شرقي", tag: "محدود", sizes: ["٣٠ مل", "٥٠ مل"], images: productGalleryImages["layali-sharqiya"], colors: [{ name: "بنفسجي", value: "hsl(280, 30%, 25%)" }], shortDescription: "ليالي شرقية الحصري.", material: "تركيبة شرقية", season: "٢٠٢٦", accordion: defaultAccordion("ليالي شرقية", "العود مع العنبر", "القاهرة"), defaultBottle: "teardrop-blue", availableBottles: ["teardrop-blue", "square-gold", "cube-rosegold"] },
];
